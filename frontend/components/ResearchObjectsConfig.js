...
export const RESEARCH_OBJECTS_PAPERS = [
  ...
  export const RESEARCH_OBJECTS_2023POSTERS = [
    {
      imgSrc:'https://bl-hub.s3.amazonaws.com/SfN+2023+logo+for+Research+Objects.png',
      title: 'Elucidating the temporal dynamics of non-invasive BioLuminescent-OptoGenetics effects in neocortex',
      venue: '2023 Meeting of Society for Neuroscience; Washington, DC',
      authors: [
        'E. Murphy, ',
        'A. Nelms, ',
        'M. Gomez-Ramirez'
      ],
      abstract:'BioLuminescent OptoGenetics (“BL-OG”) is a noninvasive chemogenetic method that enables optogenetic activation via bioluminescent light. In BL-OG, opsins are activated by bioluminescence generated by injecting a substrate (luciferin, e.g., Coelenterazine; CTZ) that is catalyzed by a photo-enzyme (luciferase, e.g., slow-burn <i>Gaussia</i> Luciferase; sbGLuc) that is molecularly tethered to an opsin. We previously showed that BL-OG can be used as a gain modulator by showing that increases in CTZ dosage proportionally increases bioluminescence activity. Importantly, we found that increases in bioluminescence activity were linearly correlated with enhancements in multi-unit activity, indicating that bioluminescence can be used as a proxy for population neural spiking. Although highly informative, these data were collected in experiments that directly injected CTZ into the brain. Thus, it is unclear whether similar relationships occur when the luciferin is injected noninvasively. Here, we image bioluminescent activity while injecting different concentrations of the luciferin (in this case h-Coelenterazine; h-CTZ) via the tail vein of mice. Similar to our previous findings, we observed that bioluminescence systematically increased as a function of h-CTZ concentration. Importantly, we observed that the onset time of bioluminescence was similar across h-CTZ concentrations, indicating that noninvasive BL-OG reactions modulate brain activity at the same time regardless of luciferin concentration. As expected, we found that higher concentrations of h-CTZ generated longer bioluminescence, but these activations were back to baseline in less than 20 minutes. We conducted additional experiments to determine whether rate of injections also modulate BL-OG’s temporal dynamics. Data reveal that faster rate of injections lead to higher maximum bioluminescence response, a quicker onset of the bioluminescence peak, and longer time decay of bioluminescence. Our studies provide critical information of how parameters of noninvasive luciferin delivery can lead to changes in BL-OG effects in brain activity. Our studies provide additional insight into the advantages of BL-OG over other chemogenetic methods (e.g., DREADDs), by demonstrating robust, fast, and relatively short-duration modulations in neural activity in awake-behaving animals.'
    },
    {
      imgSrc:'https://bl-hub.s3.amazonaws.com/SfN+2023+logo+for+Research+Objects.png',
  ...
  },
  {
    ...
    abstract:"Almost 30 years after identifying the genetic mutation underlying Huntington’s disease (HD), treatments remain limited to managing late-stage symptoms of motoric, psychiatric, and cognitive deficits. Findings from patients and mouse models of HD point to pre-symptomatic imbalances in neuronal circuit activity, well before any overt symptoms are observed. Our central hypothesis is that ma¬nipulating the firing activity within selected microcircuits be¬fore the onset of symptoms by chemogenetic inhibition and/or ex¬citation of key target populations will slow HD disease progression. A crucial early event in HD is the pathological increase in the overall excitatory output from cortex onto striatum. The enhanced excitability of cortical pyramidal neurons (CPNs) in pre-symptomatic HD is one key target for correctional intervention. The window before the onset of symptoms presents an opportunity to inhibit the firing rate of CPNs projecting to the striatum with the prospect of preventing or slowing disease progression. For manipulation of neuronal activity, we utilized bioluminescent optogenetics (BL-OG) that employs light-emitting luciferases to activate light-sensing opsins. We are testing the effects of circuit manipulation on preventing or delaying behavioral deficits in the R6/2 transgenic mouse model of HD. To selectively target CPNs projecting to the striatum, an AAV vector carrying a Cre-inducible inhibitory LMO (AAV-CamKIIa-DIO-NCS3-hGtACR1) was injected into the cortex of 3-week-old mice, while a retrogradely transported Cre-recombinase (AAVrg-hSyn-Cre-P2A-dTomato) was injected into the striatum. Two weeks later, luciferin or vehicle were administered once every other day for 2 weeks to decrease CPN firing. Rotarod, open field, and CatWalk were used to assess motor coordination, exploratory behavior, and gait function. We assessed cognitive behavior through water T-maze, novel object recognition test, and passive avoidance test. Our studies will contribute to understanding how microcircuit manipulation influences motor and cognitive behavior in HD and will drive translational progress toward novel therapeutic purposes.<br><a href='https://doi.org/10.26300/a52r-v486' class=bl-link target=_blank>View this poster in the Brown Digital Repository.</a>"
  },
];
