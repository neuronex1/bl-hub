...
const AboutUs = () => {
    ...
    return (
        ...
        <div className='mission-statement mtxl'>
            ...
            <p className='text-m'>Luminescing bamboo coral, shrimp spewing bioluminescence, and bioluminescent coral and crinoids on Education page: Bioluminescence 2009 Expedition, NOAA/OER</p>
            <br/>
